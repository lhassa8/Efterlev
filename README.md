...
**Detector breakdown — 40 total = 33 KSI-mapped + 7 supplementary 800-53-only.**
- **33 KSI-mapped detectors** evidence FRMR-Moderate KSIs directly. Together they cover **26 of 60 KSIs** at
  ...
  ≥30 KSIs.
- Detector sources: **36 from `terraform`** (read `.tf` files or `terraform show -json` output) +
