...
**Detector breakdown — 41 total = 34 KSI-mapped + 7 supplementary 800-53-only.**
- **34 KSI-mapped detectors** evidence FRMR-Moderate KSIs directly. Together they cover **27 of 60 KSIs** at
  ...
  ≥30 KSIs.
- Detector sources: **37 from `terraform`** (read `.tf` files or `terraform show -json` output) +
