...
**Detector breakdown — 36 total = 29 KSI-mapped + 7 supplementary 800-53-only.**
- **29 KSI-mapped detectors** evidence FRMR-Moderate KSIs directly. Together they cover **20 of 60 KSIs** at
  ...
  ≥30 KSIs.
- Detector sources: **34 from `terraform`** (read `.tf` files or `terraform show -json` output) +
