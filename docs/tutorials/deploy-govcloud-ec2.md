...
If you don't have a GovCloud account yet, run Efterlev from a developer laptop or commercial-AWS CI runner instead. Most of the value lands without the GovCloud-specific deployment step. See the main [README](https://github.com/efterlev/efterlev/blob/main/README.md) install section.
...
- [SPEC-10](https://github.com/efterlev/efterlev/blob/main/docs/specs/SPEC-10.md) — the AnthropicBedrockClient implementation.
- [SPEC-11](https://github.com/efterlev/efterlev/blob/main/docs/specs/SPEC-11.md) — the `LLMConfig.backend` / `region` config surface.
- [SPEC-13](https://github.com/efterlev/efterlev/blob/main/docs/specs/SPEC-13.md) — the e2e smoke harness's Bedrock path; the canonical "did this deployment actually work?" check.
- [THREAT_MODEL.md](https://github.com/efterlev/efterlev/blob/main/THREAT_MODEL.md) — what Efterlev's egress and secret-handling guarantees actually are, in detail.
- [LIMITATIONS.md](https://github.com/efterlev/efterlev/blob/main/LIMITATIONS.md) — what Efterlev does not do, period.
- AWS official docs:
